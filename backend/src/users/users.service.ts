...
export class UsersService {
    ...
    async create(createUserDto: CreateUserDto): Promise<User> {
        ...
        const hashedPassword = await bcrypt.hash(createUserDto.password, UsersService.BCRYPT_SALT_ROUNDS);
    ...
    async update(id: string, updateUserDto: UpdateUserDto): Promise<User> {
        ...
        if (updateUserDto.password) {
            updateUserDto.password = await bcrypt.hash(updateUserDto.password, UsersService.BCRYPT_SALT_ROUNDS);
        }
